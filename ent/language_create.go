...
func (lc *LanguageCreate) AddProjectIDs(ids ...int) *LanguageCreate {
	lc.mutation.AddProjectIDs(ids...)
	return lc
}

// AddProjects adds the "projects" edges to the Project entity.
func (lc *LanguageCreate) AddProjects(p ...*Project) *LanguageCreate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return lc.AddProjectIDs(ids...)
}
...
func (lc *LanguageCreate) createSpec() (*Language, *sqlgraph.CreateSpec) {
	...
	if nodes := lc.mutation.ProjectsIDs(); len(nodes) > 0 {
