...
func (lq *LanguageQuery) QueryProjects() *ProjectQuery {
	query := &ProjectQuery{config: lq.config}
...
// Returns a *NotSingularError when exactly one Language entity is not found.
...
// Returns a *NotSingularError when exactly one Language ID is not found.
...
func (lq *LanguageQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
...
func (lq *LanguageQuery) Clone() *LanguageQuery {
	...
	return &LanguageQuery{
		...
		withProjects: lq.withProjects.Clone(),
...
func (lq *LanguageQuery) WithProjects(opts ...func(*ProjectQuery)) *LanguageQuery {
	query := &ProjectQuery{config: lq.config}
	for _, opt := range opts {
		opt(query)
	}
	lq.withProjects = query
	return lq
}
...
func (lq *LanguageQuery) GroupBy(field string, fields ...string) *LanguageGroupBy {
	group := &LanguageGroupBy{config: lq.config}
...
func (lq *LanguageQuery) Select(fields ...string) *LanguageSelect {
	...
	return &LanguageSelect{LanguageQuery: lq}
}
...
func (lq *LanguageQuery) sqlAll(ctx context.Context) ([]*Language, error) {
	...
	if query := lq.withProjects; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(language.ProjectsPrimaryKey[1], fks...))
			},
...
func (lq *LanguageQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (lgb *LanguageGroupBy) Scan(ctx context.Context, v interface{}) error {
...
func (lgb *LanguageGroupBy) ScanX(ctx context.Context, v interface{}) {
...
func (lgb *LanguageGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(lgb.fields) > 1 {
		return nil, errors.New("ent: LanguageGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := lgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (lgb *LanguageGroupBy) StringsX(ctx context.Context) []string {
...
// It is only allowed when executing a group-by query with one field.
func (lgb *LanguageGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{language.Label}
	default:
		err = fmt.Errorf("ent: LanguageGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (lgb *LanguageGroupBy) StringX(ctx context.Context) string {
...
// It is only allowed when executing a group-by query with one field.
func (lgb *LanguageGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(lgb.fields) > 1 {
		return nil, errors.New("ent: LanguageGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := lgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (lgb *LanguageGroupBy) IntsX(ctx context.Context) []int {
	v, err := lgb.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (lgb *LanguageGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{language.Label}
	default:
		err = fmt.Errorf("ent: LanguageGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (lgb *LanguageGroupBy) IntX(ctx context.Context) int {
	v, err := lgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (lgb *LanguageGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(lgb.fields) > 1 {
		return nil, errors.New("ent: LanguageGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := lgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (lgb *LanguageGroupBy) Float64sX(ctx context.Context) []float64 {
...
// It is only allowed when executing a group-by query with one field.
func (lgb *LanguageGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{language.Label}
	default:
		err = fmt.Errorf("ent: LanguageGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (lgb *LanguageGroupBy) Float64X(ctx context.Context) float64 {
...
// It is only allowed when executing a group-by query with one field.
func (lgb *LanguageGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(lgb.fields) > 1 {
		return nil, errors.New("ent: LanguageGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := lgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (lgb *LanguageGroupBy) BoolsX(ctx context.Context) []bool {
	v, err := lgb.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (lgb *LanguageGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{language.Label}
	default:
		err = fmt.Errorf("ent: LanguageGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (lgb *LanguageGroupBy) BoolX(ctx context.Context) bool {
	v, err := lgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
func (lgb *LanguageGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (lgb *LanguageGroupBy) sqlQuery() *sql.Selector {
...
func (ls *LanguageSelect) Scan(ctx context.Context, v interface{}) error {
	if err := ls.prepareQuery(ctx); err != nil {
		return err
	}
	ls.sql = ls.LanguageQuery.sqlQuery(ctx)
	return ls.sqlScan(ctx, v)
}

// ScanX is like Scan, but panics if an error occurs.
func (ls *LanguageSelect) ScanX(ctx context.Context, v interface{}) {
...
func (ls *LanguageSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ls.fields) > 1 {
		return nil, errors.New("ent: LanguageSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ls.Scan(ctx, &v); err != nil {
		return nil, err
...
// StringsX is like Strings, but panics if an error occurs.
func (ls *LanguageSelect) StringsX(ctx context.Context) []string {
...
func (ls *LanguageSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{language.Label}
	default:
		err = fmt.Errorf("ent: LanguageSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (ls *LanguageSelect) StringX(ctx context.Context) string {
	v, err := ls.String(ctx)
	if err != nil {
		panic(err)
	}
...
func (ls *LanguageSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ls.fields) > 1 {
		return nil, errors.New("ent: LanguageSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ls.Scan(ctx, &v); err != nil {
		return nil, err
...
// IntsX is like Ints, but panics if an error occurs.
func (ls *LanguageSelect) IntsX(ctx context.Context) []int {
	v, err := ls.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
func (ls *LanguageSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{language.Label}
	default:
		err = fmt.Errorf("ent: LanguageSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (ls *LanguageSelect) IntX(ctx context.Context) int {
	v, err := ls.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (ls *LanguageSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ls.fields) > 1 {
		return nil, errors.New("ent: LanguageSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ls.Scan(ctx, &v); err != nil {
		return nil, err
...
// Float64sX is like Float64s, but panics if an error occurs.
func (ls *LanguageSelect) Float64sX(ctx context.Context) []float64 {
...
func (ls *LanguageSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{language.Label}
	default:
		err = fmt.Errorf("ent: LanguageSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (ls *LanguageSelect) Float64X(ctx context.Context) float64 {
...
func (ls *LanguageSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ls.fields) > 1 {
		return nil, errors.New("ent: LanguageSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ls.Scan(ctx, &v); err != nil {
		return nil, err
...
// BoolsX is like Bools, but panics if an error occurs.
func (ls *LanguageSelect) BoolsX(ctx context.Context) []bool {
	v, err := ls.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
func (ls *LanguageSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
...
// BoolX is like Bool, but panics if an error occurs.
func (ls *LanguageSelect) BoolX(ctx context.Context) bool {
	v, err := ls.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
func (ls *LanguageSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
